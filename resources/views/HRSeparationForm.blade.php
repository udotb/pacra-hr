                                            ...
                                            <form method="POST" action="{{ route('addSeparation') }}">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="leave" value="{{$leaveBalance->first()}}" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-check">
                                                        ...
                                                        @foreach($seprattionCheckList->where('attribute', 'hr') as $key=> $chkList)
                                                            <input class="form-check-input" type="checkbox" value="{{$chkList->id}}" name="chklist[]" id="invalidCheck{{$key}}" >
