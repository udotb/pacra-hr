...
{{--            <form method="POST" action="{{ route('makeEmployee') }}" method="post" enctype="multipart/form-data" files="true">--}}
{{--                @csrf--}}
{{--                <div class="row">--}}
{{--                    <div class="col-sm-6">--}}
{{--                        <div class="form-group">--}}
{{--                            <label class="col-form-label">First Name <span class="text-danger">*</span></label>--}}
{{--                            <input class="form-control" name="fname" type="text" value="{{$getProfileDetails->fname}}" readonly="readonly">--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <div class="col-sm-6">--}}
{{--                        <div class="form-group">--}}
{{--                            <label class="col-form-label">Last Name <span class="text-danger">*</span></label>--}}
{{--                            <input class="form-control" name="lname" value="{{$getProfileDetails->lname}}" type="text" readonly="readonly">--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <div class="col-sm-6">--}}
{{--                        <div class="form-group">--}}
...
{{--                    <div class="col-sm-6">--}}
{{--                        <div class="form-group">--}}
{{--                            <label class="col-form-label">Officail Email <span class="text-danger">*</span></label>--}}
...
{{--                            <small id="fileHelp" class="form-text text-muted">Please upload a valid transparent png file.</small>--}}
{{--                        </div>--}}
{{--                    </div>--}}

{{--                </div>--}}
{{--                <input type="hidden" name="applicantID" value="{{$applicantUserID}}">--}}
...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <form method="POST" action="{{ route('add_employee') }}" method="post" enctype="multipart/form-data"
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input class="form-control" type="text" placeholder="XXXXX-XXXXXXX-X" name="cnic"
                                       required="required" value="{{$getPersonalInfo->cnic  ?? ''}}">
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input class="form-control" name="phone" type="tel" pattern="[0-9]{4}[0-9]{7}"
                                       ...
                                       value="{{$getProfileDetails->contactNumber  ?? ''}}">
                                <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class=""><input class="form-control" name="emg_phone" type="tel"
                                                 ...
                                                 required="required" value="{{$getEmgInfo->phoneOne  ?? ''}}">
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input type="text" name="emg_name" class="form-control" required="required"
                                       value="{{$getEmgInfo->contactNameOne  ?? ''}}">
                                <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="nationality" required="required">
                                ...
                                <option value="{{$nationality[0]->id}}" selected>{{$nationality[0]->title}}</option>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="religion" required="required">
                                ...
                                <option value="{{$religions[0]->id}}" selected>{{$religions[0]->title}}</option>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="gender" required="required">
                                ...
                                <option value="{{$genders[0]->id}}" selected>{{$genders[0]->title}}</option>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="marital" required="required">
                                ...
                                <option value="{{$maritals[0]->id}}" selected>{{$maritals[0]->title}}</option>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="linkedin" type="text" required
                                   value="{{$getProfileDetails->linkedin  ?? ''}}">
                        </div>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="exp_outside_pacra" type="text" required value="{{$getExperienceInfo->totalExperience}}">
                            <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="last_employer" type="text" value="{{$getExperienceInfo->companyName ?? ''}}" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="address" type="text" required="required"
                                   value="{{$getProfileDetails->address  ?? ''}}">
                            <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="file" name="image" id="image"
                                   accept="image/jpg, image/jpeg" required value="{{$getProfileDetails->image  ?? ''}}">
                            <div class="invalid-feedback">
                                Please upload a valid Image File.
                            </div>
                            <small id="fileHelp" class="form-text text-muted">Please upload a valid JPG/JPEG
                                file.</small>
                            <a href="{{ "https://209.97.168.200/pacra-job-portal/public/users/" . $getProfileDetails->image  ?? '/'}}" target="_blank">View
                                Image</a>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <a href="{{"https://209.97.168.200/pacra-job-portal/public/".$getProfileDetails->cv ?? '/'}}" target="_blank">View
                                CV</a>
                        </div>
                    </div>
