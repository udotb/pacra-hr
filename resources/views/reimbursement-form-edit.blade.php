        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">{{!empty($meta_title) ? $meta_title: 'Edit Reimbursement Form'}}</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="index">Reimbursement</a></li>
                            <li class="breadcrumb-item active">{{!empty($meta_title) ? $meta_title: 'Edit Reimbursement Form'}}
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="{{ route('store-reimbursement-form') }}"
                                  ...
                                  files="true">
                                @csrf
                                <input value="{{$reimbursementData[0]->id}}" name="record_id" type="hidden">
                                <div class="form-group">
                                    ...
                                    <select id="multiple" class="form-control reimbursementType"
                                            ...
                                            multiple="">
                                        <option selected
                                                value="{{str_replace($spam, ' ', $reimbursementData[0]->type ?? '')}}"></option>
                                ...
                                <div class="form-group" id="travelType">
                                    ...
                                    <select class="select" name="travelType" required="required" id="tt2">
                                        <option selected
                                                value="{{$reimbursementData[0]->travel_type}}">{{$reimbursementData[0]->travel_type}}</option>
...
{{--                                @if(!empty($reimbursementData[0]->type[0]->type == 'Medical'))--}}
                                <div class="form-group">
                                    <label>Medical Type <span class="text-danger">*</span></label>
                                    <select class="select" name="medicalType">
                                        <option selected
                                                value="{{$reimbursementData[0]->medical_type}}">{{$reimbursementData[0]->medical_type}}</option>
...
{{--                                @endif--}}
                                @if($reimbursementData[0]->travel_type == 1 || $reimbursementData[0]->travel_type == 2 || $reimbursementData[0]->travel_type == 3)
                                <div class="form-group">
                                    <label>Travel Amount <span class="text-danger">*</span></label>
                                    <input class="form-control" name="travelAmount">
                                </div>
                                @endif
                                @if($reimbursementData[0]->travel_type == 4)
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" id="from_date" name="from_date"
                                           ...
                                           class="form-control" value="{{$reimbursementData[0]->from_date ?? ''}}">
                                </div>
                                <div class="form-group">
                                    <label>To Date <span class="text-danger">*</span></label>
                                    <input type="date" id="to_date" name="to_date"
                                           max="{{\Carbon\Carbon::now()->addDays(10)->format('Y-m-d')}}"
                                           class="form-control" value="{{$reimbursementData[0]->to_date}}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <textarea class="form-control" cols="9" rows="3" required="required"
                                                  name="description"
                                                  placeholder="Enter Description">{{$reimbursementData[0]->description ?? ''}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group" id="clientDiv">
                                    ...
                                    <select class="form-control selectpicker" name="client"
                                        ...
                                        <option selected value="{{$reimbursementData[0]->client ?? ''}}">{{$reimbursementData[0]->client ?? ''}}</option>
                                ...
                                <div class="form-group" id="otherClientDiv">
                                    <input class="form-control" name="otherClient" required="required"
                                           id="otherClientInput" value="{{$reimbursementData[0]->other_client}}">
                                </div>
