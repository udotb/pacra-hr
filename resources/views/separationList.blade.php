                    ...
                    <div class="table-responsive">
                        <table class="table table-striped custom-table mb-0 datatable"
                            ...
                            @php
                                ...
                                @endphp
                            @if(in_array('27', $userRights))

                                @foreach($resignation->where('section_two_name', null) as $key=>$resig)
                                    <tr>
                                        <td>{{ $key+1}}</td>
                                        <td>
                                ...
                                @endforeach
                            @endif
                            @if(in_array('22', $userRights))

                                @foreach($resignation->where('section_three_name', null) as $key=>$resig)
                                    <tr>
                                        <td>{{ $key+1}}</td>
                                        <td>
                                            <h2 class="table-avatar blue-link">
                            ...
                            @if(in_array('23', $userRights))
                                ...
                                {{--
                                                                    @foreach($resignation->where('section_three_name', !null and 'section_four_name', null ) as $key=>$resig)
                                --}}
                                @foreach($resignation->where('section_three_name', null ) as $key=>$resig)
                                    <tr>
                                        <td>{{ $key+1}}</td>
                            ...
                            @if(in_array('24', $userRights))
                                ...
                                --}}
                                @foreach($resignation->where('section_four_name', !null ) as $key=>$resig)
                                    <tr>
                                        <td>{{ $key+1}}</td>
                                        <td>
                                            <h2 class="table-avatar blue-link">
