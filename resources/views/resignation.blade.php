            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto float-right ml-auto">
                        ...
                        @elseif($resignation->isNotEmpty() and $resignation->first()->status == 'Approved' )

                            <a href="{{ route('empSeparationForm') }}/{{!empty($resignation->first()->resigID) ? $resignation->first()->resigID: ''}}"
                               class="btn add-btn" target="_blank"><i class="fa fa-plus"></i> Separation Process</a>
                        @elseif ($resignation->isNotEmpty() and $resignation->first()->status == 'Entered' )
                            <a href="{{ route('empSeparationForm') }}/{{!empty($resignation->first()->resigID) ? $resignation->first()->resigID: ''}}"
                               class="btn add-btn" target="_blank"><i class="fa fa-plus"></i> Separation Process</a>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-striped custom-table mb-0 datatable"
                            ...
                            @foreach ($resignation as $index => $resig)
                                <tr>
                                    <td>{{$index+1}}</td>
                                    <td>
