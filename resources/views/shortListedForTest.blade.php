                    ...
                    <div class="table-responsive">
                        <table class="table table-striped custom-table mb-0 datatable"
                            ...
                            @foreach($candidateLists as $index=>$candidateList)
                                <tr>
                                    <td>{{$index+1}}</td>
                                    <td>{{$candidateList->jobTitlesTable}}</td>
                                    ...
                                    <td>{{$candidateList->testDate}}</td>
                                    <td>{{$candidateList->testTime}}</td>
                                    <td>{{$candidateList->conductorFname}} {{$candidateList->conductorLname}}</td>
                                        ...
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item"
                                                   href="{{route('scheduleInterview') }}/{{$candidateList->userID}}/{{$candidateList->candidateID}}/{{$candidateList->jobID}}"><i
                                                        class="fa fa-clock-o m-r-5"></i> Schedule Interview</a>
                                                <a class="dropdown-item"
                                                   href="{{route('scheduleInterviewCEO') }}/{{$candidateList->userID}}/{{$candidateList->candidateID}}/{{$candidateList->jobID}}"><i
                                                        class="fa fa-clock-o m-r-5"></i> Schedule Interview with CEO</a>
                                                <a class="dropdown-item"
                                                   href="{{ route('reject-absent', $candidateList->recordId) }}"><i
