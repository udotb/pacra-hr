...
{{--                                        <td>{{$candidateList->display_name}}</td>--}}
                                        <td><h2 class="user-name m-t-10 mb-0 text-ellipsis">
                                            <a href="{{ url('candidateProfile') }}/{{$candidateList->userID}}/{{$candidateList->jobID}}" target="_blank">{{$candidateList->fname}} {{$candidateList->lname}}</a> </h2></td>
                                        <td>{{$candidateList->date}}</td>
                                        <td>{{$candidateList->time}}</td>
                                        <td>{{$candidateList->interviewRound}}</td>
                                        <td>{{$candidateList->interviewerFname}} {{$candidateList->interviewerLname}}</td>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="{{route('scheduleInterviewCEO') }}/{{$candidateList->userID}}/{{$candidateList->candidateID}}/{{$candidateList->jobID}}"><i class="fa fa-clock-o m-r-5"></i> Schedule Interview with CEO</a>
