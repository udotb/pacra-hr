...
<link rel="stylesheet" href="{{asset('appointmentLetter/base.min.css')}}"/>
<link rel="stylesheet" href="{{asset('appointmentLetter/fancy.min.css')}}"/>
<link rel="stylesheet" href="{{asset('appointmentLetter/main.css')}}"/>
<script src="{{asset('appointmentLetter/compatibility.min.js')}}"></script>
<script src="{{asset('appointmentLetter/theViewer.min.js')}}"></script>
<script>
try{
theViewer.defaultViewer = new theViewer.Viewer({});
}catch(e){}
</script>
<title>{{!empty($meta_title) ? $meta_title: 'PACRA'}}</title>
</head>
<body>
<div id="sidebar">
<div id="outline">
...
<div id="pf1" class="pf w0 h0" data-page-no="1">
    ...
    @if($getProfileDetails->first()->status =='entered')
    <div class="pc pc1 w0 h0"><img class="bi x0 y0 w1 h1" alt="" src="{{asset('appointmentLetter/bg2.png')}}"/>

    @elseif($getProfileDetails->first()->status =='approved')
    <div class="pc pc1 w0 h0"><img class="bi x0 y0 w1 h1" alt="" src="{{asset('appointmentLetter/bg1.png')}}"/>
    ...
    @endif
        ...
        <div class="c x1 y1 w2 h0">
            ...
            <div class="t m0 x5 h9 yb ff3 fs5 fc0 sc0 ls0 ws0">Ref: {{$getProfileDetails->first()->refrence}} <span class="_ _3"> </span> <span class="_ _4"> </span> <span class="_ _4"> </span> <span class="_ _4"> </span> <span class="_ _4"> </span> <span class="_ _4"> </span>                          <span class="_ _0"></span>              <span class="_ _5"> </span>            <span class="_ _6"> </span>{{date('d-M-y', strtotime($getProfileDetails->first()->date))}} </div>
            <div class="t m0 x5 h9 yc ff3 fs5 fc0 sc0 ls0 ws0">Employee No.: {{$getProfileDetails->first()->candidateEmpNo}} </div>
            <div class="t m0 x5 h9 yd ff3 fs5 fc0 sc0 ls0 ws0">Grade: <span class="ls4">{{$getProfileDetails->first()->gradeTitle}}<span class="_ _0"></span><span class="ls0"> </span></span>
            </div>
            <div class="t m0 x5 h9 ye ff3 fs5 fc0 sc0 ls0 ws0"> </div>
            <div class="t m0 x5 ha yf ff2 fs5 fc0 sc0 ls0 ws0">{{$getProfileDetails->first()->fname}} {{$getProfileDetails->first()->lname}} </div>
            <div class="t m0 x5 h9 y10 ff3 fs5 fc0 sc0 ls0 ws0">{{$getProfileDetails->first()->email}}</div>
            <div class="t m0 x5 h9 y11 ff3 fs5 fc0 sc0 ls0 ws0">{{$getProfileDetails->first()->contactNumber}}</div>
            <div class="t m0 xc hb y12 ff2 fs6 fc0 sc0 ls0 ws0">Appointment Letter </div>
            <div class="t m0 x5 ha y13 ff3 fs5 fc0 sc0 ls0 ws0">Dear <span class="ff2">{{$getProfileDetails->first()->fname}} {{$getProfileDetails->first()->lname}}<span>
            </div>

            <div class="t m0 x5 h9 y14 ff3 fs5 fc0 sc0 ls0 ws0"> </div>
            <div class="t m0 x5 ha y15 ff4 fs5 fc0 sc0 ls0 ws0">We are pleased to offer you the position of “<span class="ff2">{{$getProfileDetails->first()->desigTitle}}</span>”. Your monthly salary package will be as under:<span class="ff3"> </span>
            </div>
