            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="modal-content">
                        ...
                        <!-- Employee Separation Form | MIT Section 3-->
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h4>Section - 3	| MIT Function  | To be affirmed by respective Head </h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm">
                                            ...
                                            <form method="POST" action="{{ route('addSeparation') }}">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-check">
                                                        ...
                                                        @foreach($seprattionCheckList->where('attribute', 'mit') as $key=> $chkList)
                                                ...
                                                <button class="btn btn-primary" type="submit" name="submit" value="mit_submit">Submit form</button>
                                            </form>
