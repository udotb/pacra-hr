                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="form-group form-focus select-focus">
                            <select class="floating selectpicker" name="empId" data-show-subtext="true" data-live-search="true">                                                
                                ...
                                @foreach($all_users->groupBy('display_name') as $all_user)
                    ...
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            <div class="profile-img">
                                <a href="profile" class="avatar"><img src="{{asset('users/')}}/{{$users->avatar_file}}" alt=""></a>
                            </div>
...
--}}{{--
                            ...
                            <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{ url('approvalProfile') }}/{{$users->id}}" target="_blank">{{$users->display_name}}</a></h4>
