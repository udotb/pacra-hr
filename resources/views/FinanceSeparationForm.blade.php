                                            ...
                                            <form method="POST" action="{{ route('addSeparation') }}">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-check">
                                                        ...
                                                        @foreach($seprattionCheckList->where('attribute', 'finance') as $key=> $chkList)
                                                            <input class="form-check-input" type="checkbox" value="{{$chkList->id}}" name="chklist[]" id="invalidCheck{{$key}}" required >
