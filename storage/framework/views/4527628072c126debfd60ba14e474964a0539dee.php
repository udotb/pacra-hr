                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            <a class="dropdown-item" href="" target="_blank"><i
                                                ...
                                                <?php if($resig->section_two_name == null): ?>
                                                    TL
                                                <?php elseif($resig->section_three_name == null): ?>
                                                    MIT
                                                <?php elseif($resig->section_four_name == null): ?>
                                                    Administration
                                                <?php elseif($resig->section_five_name == null): ?>
                                                    HR
                                                <?php elseif($resig->section_seven_name == null): ?>
                                                    Finance
                                                <?php elseif($resig->section_eight_name == null): ?>
                                                    CEO
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\pacra-hrms\resources\views/separationReport.blade.php ENDPATH**/ ?>