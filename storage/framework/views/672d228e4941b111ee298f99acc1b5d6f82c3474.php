            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="modal-content">
                        ...
                        <!-- Employee Separation Form | HR Section 5-->
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h4>Section - 5	| HR Function | To be affirmed by respective Head </h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm">
                                            ...
                                            <form method="POST" action="<?php echo e(route('addSeparation')); ?>">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <label for="validationDefault02">Leave Balance</label>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-check">
                                                        ...
                                                        <?php $__currentLoopData = $seprattionCheckList->where('attribute', 'hr'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $chkList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <input class="form-check-input" type="checkbox" value="<?php echo e($chkList->id); ?>" name="chklist[]" id="invalidCheck<?php echo e($key); ?>" >
                                                ...
                                                <button class="btn btn-primary" type="submit" name="submit" value="hr_submit">Submit form</button>
                                            </form>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\pacra-hrms\resources\views/HRSeparationForm.blade.php ENDPATH**/ ?>