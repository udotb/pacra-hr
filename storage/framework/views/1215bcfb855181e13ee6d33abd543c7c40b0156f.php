        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title"><?php echo e(!empty($meta_title) ? $meta_title: 'Edit Reimbursement Form'); ?></h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="index">Reimbursement</a></li>
                            <li class="breadcrumb-item active"><?php echo e(!empty($meta_title) ? $meta_title: 'Edit Reimbursement Form'); ?>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="<?php echo e(route('store-reimbursement-form')); ?>"
                                  ...
                                  files="true">
                                <?php echo csrf_field(); ?>
                                <input value="<?php echo e($reimbursementData[0]->id); ?>" name="record_id" type="hidden">
                                <div class="form-group">
                                    ...
                                    <select id="multiple" class="form-control reimbursementType"
                                            ...
                                            multiple="">
                                        <option selected
                                                value="<?php echo e(str_replace($spam, ' ', $reimbursementData[0]->type ?? '')); ?>"></option>
                                ...
                                <div class="form-group" id="travelType">
                                    <label>Travel Type <span class="text-danger">*</span></label>
                                    <select class="select" name="travelType" required="required" id="tt2">
                                        <option selected
                                                value="<?php echo e($reimbursementData[0]->travel_type); ?>"><?php echo e($reimbursementData[0]->travel_type); ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select" name="medicalType">
                                        <option selected
                                                value="<?php echo e($reimbursementData[0]->medical_type); ?>"><?php echo e($reimbursementData[0]->medical_type); ?></option>
                                ...
                                <?php if($reimbursementData[0]->travel_type == 1 || $reimbursementData[0]->travel_type == 2 || $reimbursementData[0]->travel_type == 3): ?>
                                <div class="form-group">
                                    <label>Travel Amount <span class="text-danger">*</span></label>
                                    <input class="form-control" name="travelAmount">
                                </div>
                                <?php endif; ?>
                                <?php if($reimbursementData[0]->travel_type == 4): ?>
                                <div class="form-group">
                                    <label>KMs Travelled <span class="text-danger">*</span></label>
                                    <input class="form-control" name="kms">
                                </div>
                                <?php endif; ?>
                                <div class="form-group">
                                    ...
                                    <input type="date" id="from_date" name="from_date"
                                           ...
                                           class="form-control" value="<?php echo e($reimbursementData[0]->from_date ?? ''); ?>">
                                </div>
                                <div class="form-group">
                                    <label>To Date <span class="text-danger">*</span></label>
                                    <input type="date" id="to_date" name="to_date"
                                           max="<?php echo e(\Carbon\Carbon::now()->addDays(10)->format('Y-m-d')); ?>"
                                           class="form-control" value="<?php echo e($reimbursementData[0]->to_date); ?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <textarea class="form-control" cols="9" rows="3" required="required"
                                                  name="description"
                                                  placeholder="Enter Description"><?php echo e($reimbursementData[0]->description ?? ''); ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group" id="clientDiv">
                                    ...
                                    <select class="form-control selectpicker" name="client"
                                        ...
                                        <option selected value="<?php echo e($reimbursementData[0]->client ?? ''); ?>"><?php echo e($reimbursementData[0]->client ?? ''); ?></option>
                                ...
                                <div class="form-group" id="otherClientDiv">
                                    <input class="form-control" name="otherClient" required="required"
                                           id="otherClientInput" value="<?php echo e($reimbursementData[0]->other_client); ?>">
                                </div>
                                <div class="form-group" id="otherAmountDiv">
                                    <label>Amount <span class="text-danger">*</span></label>
                                    <input class="form-control" name="otherAmount" required="required"
                                           id="otherAmountInput">
                                </div>
                                <?php if($userId == 10): ?>
                                    <div class="form-group">
                                        <label>Actual Amount <span class="text-danger">*</span></label>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\pacra-hrms\resources\views/reimbursement-form-edit.blade.php ENDPATH**/ ?>