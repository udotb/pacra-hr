                        ...
                        <table class="table table-striped custom-table mb-0 datatable"
                            ...
                            <?php $__currentLoopData = $hiringRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $hiringRequest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(date('d-M-y', strtotime($hiringRequest->created_at))); ?></td>

                                    <td> <?php if($hiringRequest->status == 'entered'): ?>
                                            <h5 style="color: #0ba408">Entered</h5>
                                        <?php elseif($hiringRequest->status == 'recommended'): ?>
                                            <h5 style="color: #0ba408">Recommended</h5>
                                        <?php elseif($hiringRequest->status == 'authenticate'): ?>
                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="openEditModel dropdown-item"
                                                       href="<?php echo e(route('hiringRequestForm')); ?>/<?php echo e(!empty($hiringRequest->id) ? $hiringRequest->id: ''); ?>"
                                                       target="_blank"><i class="fa fa-pencil m-r-5"></i> Edit / Approve</a>
                                                    <a class="dropdown-item"
                                                       href="<?php echo e(url('hiringRequest/delete', $hiringRequest->id)); ?>">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="modal-btn delete-action">
                                <div class="row">
                                    <div class="col-6">
                                        <a href="<?php echo e(url('hiringRequest/delete', $hiringRequest->id)); ?>"
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\pacra-hrms\resources\views/hiringRequest.blade.php ENDPATH**/ ?>