...
<div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								<h3 class="page-title">Remaining Employees In Office</h3>
								<ul class="breadcrumb">
                                ...
                                <table class="table table-striped custom-table mb-0 datatable"
									...
									<?php $__currentLoopData = $today_attendance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr>
											...
											<?php         $ipAddresses = array('125.209.73.138', '110.37.226.186', '175.107.239.42', '202.141.241.58', '110.39.42.115');
                                            ?>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\pacra-hrms\resources\views/in-office.blade.php ENDPATH**/ ?>